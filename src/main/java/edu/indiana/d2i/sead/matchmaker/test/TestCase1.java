...
public class TestCase1 {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
...
*/
		...
		MatchMakingList initList=new MatchMakingList((ArrayNode)reposGen.getJsonTree());
